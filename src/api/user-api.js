...
import { UserCredentialsSpec, UserSpecPlus, UserSpec, UserArray, IdSpec, JwtAuth } from "../models/joi-schemas.js";
...
export const userApi = {
  ...
  create: {
    ...
    handler: async function (request, h) {
      ...
      try {
        const { type, ...userData } = request.payload;
        const user = await db.userStore.addUser(userData, type);
